...
const writeRefundsFromFinances = async (spreadsheetId, sheetName, startDate, endDate) => {
...
writeRefundsFromFinances(process.env.SPREADSHEET_ID, "refunds", "2025-02-21", "2025-03-21");
