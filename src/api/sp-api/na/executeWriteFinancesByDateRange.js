...
const writeFinancesByRange = async (spreadsheetId, range, startDate, endDate) => {
  const start = `${startDate}T00:00:00-07:00`; // `${getStartOfYesterday()}-07:00`
  const end = `${endDate}T23:59:59-07:00`; //`${getEndOfYesterday()}-07:00`
...
writeFinancesByRange(process.env.SPREADSHEET_ID, "getFinances!A3:Z", "2025-03-22", "2025-03-24");

module.exports = {
  writeFinancesByRange,
};
