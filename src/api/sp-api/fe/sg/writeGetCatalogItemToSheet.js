...
const writeGetCatalogItemToSheetSg = async (spreadsheetId, sheetName) => {
  // マーケットプレイスの読み込み
...
module.exports = {
  writeGetCatalogItemToSheetSg,
};

// writeValue();
// writeGetCatalogItemToSheetSg(process.env.SPREADSHEET_ID, "SGfetchProdInfo");
