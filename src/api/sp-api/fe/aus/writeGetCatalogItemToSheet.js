...
const { getCatalogItemFromSheet } = require("./fetchGetCatalogItem.js");
...
const writeGetCatalogItemToSheetAu = async (spreadsheetId, sheetName) => {
  // マーケットプレイスの読み込み
...
module.exports = {
  writeGetCatalogItemToSheetAu,
};

// writeValue();
// writeGetCatalogItemToSheetAu(process.env.SPREADSHEET_ID, "AUfetchProdInfo");
